...
export function spendingLimitUse({ multisigPda, member, spendingLimit, mint, vaultIndex, amount, decimals, destination, tokenProgram = TOKEN_PROGRAM_ID, memo, programId = PROGRAM_ID, }) {
