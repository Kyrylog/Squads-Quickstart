...
import { createVaultTransactionExecuteInstruction, PROGRAM_ID, VaultTransaction, } from "../generated";
import { accountsForTransactionExecute } from "../utils";
export async function vaultTransactionExecute({ connection, multisigPda, transactionIndex, member, programId = PROGRAM_ID, }) {
