 ...
 */
export declare function multisigCreate({ blockhash, configAuthority, createKey, creator, multisigPda, threshold, members, timeLock, rentCollector, memo, programId, }: {
    blockhash: string;
    createKey: PublicKey;
    creator: PublicKey;
