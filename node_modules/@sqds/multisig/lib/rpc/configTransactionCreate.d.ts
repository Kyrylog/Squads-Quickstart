...
export declare function configTransactionCreate({ connection, feePayer, multisigPda, transactionIndex, creator, rentPayer, actions, memo, signers, sendOptions, programId, }: {
