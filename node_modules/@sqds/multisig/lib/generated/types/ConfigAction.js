...
export const isConfigActionSetRentCollector = (x) => x.__kind === 'SetRentCollector';
/**
 * @category userTypes
 * @category generated
 */
export const configActionBeet = beet.dataEnum([
    ...
    [
        'SetRentCollector',
        new beet.FixableBeetArgsStruct([['newRentCollector', beet.coption(beetSolana.publicKey)]], 'ConfigActionRecord["SetRentCollector"]'),
    ],
]);
